...
INSERT INTO `wk_dept` (`id`, `parent_id`, `name`, `full_name`, `unique_key`, `type`, `status`, `order_num`, `remark`, `create_time`, `update_time`) VALUES
...
CREATE TABLE `wk_dictionary` (
  ...
  `type` tinyint(2) UNSIGNED NOT NULL DEFAULT '1' COMMENT '1.文本 2.数字 3.数组 4.单选 5.多选 6.下拉 7.日期 8.时间 9.单图 10.多图 11.单文件 12.多文件',
  `unique_key` varchar(50) NOT NULL COMMENT '唯一值',
...
--
-- 转存表中的数据 `wk_dictionary`
--

INSERT INTO `wk_dictionary` (`id`, `parent_id`, `name`, `type`, `unique_key`, `value`, `status`, `order_num`, `remark`, `create_time`, `update_time`) VALUES
...
(4, 1, '更新个人资料', 1, 'wk_userinfo', '', 0, 0, '', '2022-08-25 03:28:36', '2022-08-27 01:20:52');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE = utf8mb4_general_ci COMMENT='工作岗位';

--
-- 转存表中的数据 `wk_job`
--

INSERT INTO `wk_job` (`id`, `name`, `status`, `order_num`, `create_time`, `update_time`) VALUES
...
CREATE TABLE `wk_perm_menu` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE = utf8mb4_general_ci COMMENT='权限&菜单';

--
-- 转存表中的数据 `wk_perm_menu`
--

INSERT INTO `wk_perm_menu` (`id`, `parent_id`, `name`, `router`, `perms`, `type`, `icon`, `order_num`, `view_path`, `is_show`, `active_router`, `create_time`, `update_time`) VALUES
...
(49, 45, '后端仓库', 'https://github.com/arklnk/muse-admin', '[]', 1, '', 0, '', 1, '', '2022-08-29 09:26:24', '2022-08-29 09:30:47');
...
--
-- 转存表中的数据 `wk_profession`
--

INSERT INTO `wk_profession` (`id`, `name`, `status`, `order_num`, `create_time`, `update_time`) VALUES
...
INSERT INTO `wk_role` (`id`, `parent_id`, `name`, `unique_key`, `remark`, `perm_menu_ids`, `status`, `order_num`, `create_time`, `update_time`) VALUES
...
INSERT INTO `wk_user` (`id`, `account`, `password`, `username`, `nickname`, `avatar`, `gender`, `email`, `mobile`, `profession_id`, `job_id`, `dept_id`, `role_ids`, `status`, `order_num`, `remark`, `create_time`, `update_time`) VALUES
(1, 'admin', '596bfe4bb02db60c2a25965598529e7e', 'admin', 'admin', 'https://avataaars.io/?avatarStyle=Circle&topType=Hat&accessoriesType=Prescription02&facialHairType=BeardLight&facialHairColor=BrownDark&clotheType=Hoodie&clotheColor=Heather&eyeType=Default&eyebrowType=Default&mouthType=Default&skinColor=Light', 0, 'admin@zmex.com', '', 0, 0, 0, '[1]', 1, 0, '超级管理员', '2022-08-11 06:19:45', '2022-08-27 01:41:43'),
(2, 'demo', '596bfe4bb02db60c2a25965598529e7e', 'demo', '', 'https://avataaars.io/?avatarStyle=Circle&topType=Hat&accessoriesType=Sunglasses&facialHairType=Blank&clotheType=Hoodie&clotheColor=Heather&eyeType=Hearts&eyebrowType=UpDown&mouthType=Tongue&skinColor=DarkBrown', 0, '', '', 2, 2, 1, '[2]', 1, 0, '普通用户', '2022-08-23 14:04:24', '2022-08-28 08:44:01');
...
-- 表的索引 `wk_perm_menu`
--
ALTER TABLE `wk_perm_menu`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `wk_profession`
--
ALTER TABLE `wk_profession`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);
