...
func SupervisorScheduleEditHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SupervisorScheduleEditReq
		if err := httpx.Parse(r, &req); err != nil {
			response.ErrorCtx(r.Context(), w, errs.WithCode(err, errs.ErrCodeParamsAbnormal), nil)
			return
		}

		l := supervisor.NewSupervisorScheduleEdit(r.Context(), svcCtx)
		resp, err := l.SupervisorScheduleEdit(&req)
		if err != nil {
