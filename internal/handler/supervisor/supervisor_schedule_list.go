...
func SupervisorScheduleListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SupervisorListReq
		if err := httpx.Parse(r, &req); err != nil {
			response.ErrorCtx(r.Context(), w, errs.WithCode(err, errs.ErrCodeParamsAbnormal), nil)
			return
		}

		l := supervisor.NewSupervisorScheduleList(r.Context(), svcCtx)
		resp, err := l.SupervisorScheduleList(&req)
		if err != nil {
