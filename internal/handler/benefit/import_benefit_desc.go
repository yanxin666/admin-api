...
func ImportBenefitDescHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ImportBenefitDescReq
		if err := httpx.Parse(r, &req); err != nil {
			response.ErrorCtx(r.Context(), w, errs.WithCode(err, errs.ErrCodeParamsAbnormal), nil)
			return
		}

		l := benefit.NewImportBenefitDesc(r.Context(), svcCtx)
		resp, err := l.ImportBenefitDesc(&req)
		if err != nil {
