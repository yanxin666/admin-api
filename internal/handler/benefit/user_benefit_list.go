...
func UserBenefitListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserBenefitListReq
		if err := httpx.Parse(r, &req); err != nil {
			response.ErrorCtx(r.Context(), w, errs.WithCode(err, errs.ErrCodeParamsAbnormal), nil)
			return
		}

		l := benefit.NewUserBenefitList(r.Context(), svcCtx)
		resp, err := l.UserBenefitList(&req)
		if err != nil {
