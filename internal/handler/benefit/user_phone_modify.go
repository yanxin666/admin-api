...
func UserPhoneModifyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserPhoneModifyReq
		if err := httpx.Parse(r, &req); err != nil {
			response.ErrorCtx(r.Context(), w, errs.WithCode(err, errs.ErrCodeParamsAbnormal), nil)
			return
		}

		l := benefit.NewUserPhoneModify(r.Context(), svcCtx)
		resp, err := l.UserPhoneModify(&req)
		if err != nil {
