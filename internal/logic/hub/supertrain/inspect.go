...
func (l *Inspect) Inspect(req *types.HubSuperTrainInspectReq) (resp *types.Result, err error) {
	...
	err = l.svcCtx.HubSuperTrainModel.UpdateOperateStatus(l.ctx, data.Id, 1, userId, "审核通过")
	if err != nil {
		return nil, err
	}
